...
//Route::get('Videojuego', 'VideojuegoController@index');
//Route::get('/Videojuego/create', 'VideojuegoController@create');
//Route::get('/Videojuego/store', 'VideojuegoController@store');
//Route::get('/Videojuego/show', 'VideojuegoController@show');
//Route::get('/Videojuego/edit', 'VideojuegoController@edit');
//Route::get('/Videojuego/update', 'VideojuegoController@update');
//Route::get('/Videojuego/destroy', 'VideojuegoController@destroy');


Route::resource('videojuegos', VideojuegoController::class);
Route::resource('generos', GeneroController::class);

Route::post('/videojuegos/{videojuego}/agregar_genero',
 [VideojuegoController::class, 'agregar_genero'])->name('videojuegos.agregar_genero');
